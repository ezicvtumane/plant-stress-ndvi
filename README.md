...
* **Целевые конкурсы и конференции**:
  1. Всероссийский конкурс научно-технологических проектов **«Большие вызовы»** (Образовательный центр «Сириус»), трек *«Агропромышленные и биотехнологии»*.
  2. **Конкурс научно-исследовательских проектов школьников Санкт-Петербургского государственного университета (СПбГУ)**, направление *«Биология, экология и науки о жизни»* (секция: Биофизика, физиология растений и агробиотехнологии).
  3. Международная молодежная научная конференция школьников и студентов СПбГУ.
...
## 🏛️ Материалы для Санкт-Петербургского государственного университета (СПбГУ)

Для экспертного рецензирования и участия в **Конкурсе научно-исследовательских проектов школьников СПбГУ** и **Международной молодежной научной конференции школьников и студентов СПбГУ** (секция *«Биология, экология и науки о жизни» / «Биофизика, физиология растений и агробиотехнологии»*) подготовлен комплект официальной академической документации:

* 📑 **[Краткая научно-информационная записка для рецензирования (СПбГУ)](docs/Краткая_записка_для_рецензирования_СПбГУ_Ковалева_Алиса.pdf)** — **специальный 2-страничный документ (A4)** для быстрого ознакомления, экспертной оценки и рецензирования научными консультантами и экспертами СПбГУ. Содержит паспорт проекта, формулировку проблемы и гипотезы, описание аппаратно-программного стенда, сводную таблицу кинетики 7-суточного биоэксперимента, математическую статистику (ANOVA $p < 0.001$, Mann-Whitney), доказательство «окна спасения» на $t = 40$ ч (опережение на 36–54 ч) и специальный блок критериев экспертной оценки с полями для рецензента. Также доступна [HTML-версия](docs/Краткая_записка_для_рецензирования_СПбГУ_Ковалева_Алиса.html).
* 📄 **[Полная научно-исследовательская работа (СПбГУ)](docs/Научно_исследовательская_работа_СПбГУ_Ковалева_Алиса.pdf)** — фундаментальная научная статья (14 страниц) по академическим стандартам СПбГУ и ГОСТ Р 7.0.100-2018 (УДК 581.1, аннотация на русском и английском, 20 источников литературы).
* 📋 **[Паспорт исследовательского проекта СПбГУ](docs/Паспорт_проекта_СПбГУ_Ковалева_Алиса.md)** — паспорт проекта по установленной форме СПбГУ (проблема, календарный план, смета расходов 11 850 руб., апробация).
* 📝 **[Тезисы доклада для сборника трудов СПбГУ](docs/Тезисы_доклада_СПбГУ_Ковалева_Алиса.md)** — тезисы для публикации в материалах университетской конференции.
...
├── docs/                      <- Документация, материалы для Сириуса и СПбГУ
│   ├── Научно_исследовательская_работа_СПбГУ_...pdf <- Статья по стандартам СПбГУ
│   ├── Паспорт_проекта_СПбГУ_...md <- Паспорт проекта для СПбГУ
│   ├── Тезисы_доклада_СПбГУ_...md  <- Тезисы для сборника трудов СПбГУ
