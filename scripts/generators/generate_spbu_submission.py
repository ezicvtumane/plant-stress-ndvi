...
<div class="page-break">
    ...
    <ol>
        <li><b>Вычислительное ядро</b>: микрокомпьютер Orange Pi 4 Pro (8-ядерный процессор Allwinner A733 / sun60iw2: 2 ядра Cortex-A76 @ 2.0 ГГц + 6 ядер Cortex-A55 @ 1.8 ГГц, 4 ГБ LPDDR4 RAM, 64 ГБ высокоскоростной NVMe SSD, ОС Armbian Linux kernel 6.6).</li>
