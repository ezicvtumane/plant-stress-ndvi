...
flowchart TD
    ...
    subgraph Phase2["ЭТАП 2: Валидация гипотезы обратимости и «точки невозврата» (3 кассеты, 27 растений)"]
        P2_C1["Кассета 1: КОНТРОЛЬ<br/>(Параллельный эталон)"] --> P2_R1["Стабильная норма микроклимата"]
        P2_C4["Кассета 4: РАННЕЕ СПАСЕНИЕ<br/>(Полив на 40-м ч по сигналу станции)"] --> P2_R4["Коэффициент репарации K_rec = 98.2%<br/>Транспирация включилась за 2 ч<br/>100% сохранение биомассы!"]
        P2_C5["Кассета 5: ПОЗДНЕЕ СПАСЕНИЕ<br/>(Полив на 72-м ч при увядании)"] --> P2_R5["Коэффициент репарации K_rec = 54.1%<br/>Необратимый некроз тканей<br/>Потеря до 45% урожайности!"]
    end
