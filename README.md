...
[![Affiliation SPbU](https://img.shields.io/badge/Научный%20партнер-СПбГУ%20Биофак-red.svg)](https://spbu.ru/)
...
* **Автор проекта**: **Ковалева Алиса** (Kovaleva Alisa), учащаяся 10 класса (г. Санкт-Петербург)
...
* **Академическая консультация**: Санкт-Петербургский государственный университет (**СПбГУ**), Биологический факультет, Кафедра физиологии и биохимии растений.
...
├── docs/
│   ├── SCIENTIFIC_PASSPORT.md <- Научно-технический паспорт проекта (СПбГУ / Сириус)
...
@software{kovaleva2026plantstress,
  ...
  note = {Всероссийский конкурс научно-технологических проектов «Большие вызовы», ОЦ «Сириус» / СПбГУ}
}
```
