...
Для участия в **Конкурсе научно-исследовательских проектов школьников СПбГУ** и **Международной молодежной научной конференции школьников и студентов СПбГУ** (секция *«Биофизика, физиология растений и агробиотехнологии»*) подготовлен комплект официальной академической документации:

* 📄 **[Научно-исследовательская работа (СПбГУ)](docs/Научно_исследовательская_работа_СПбГУ_Ковалева_Алиса.pdf)** — полная научная статья по академическим стандартам СПбГУ и ГОСТ Р 7.0.100-2018. Содержит УДК 581.1, аннотацию (Abstract) на русском и английском языках, обзор литературы (20 источников), полное описание физического демультиплексирования NoIR, двухфакторный дисперсионный анализ ANOVA ($p < 0.001$), критерий Манна-Уитни, анализ «окна спасения» и рекомендации для АПК. Также доступна [HTML-версия](docs/Научно_исследовательская_работа_СПбГУ_Ковалева_Алиса.html).
* 📋 **[Паспорт исследовательского проекта СПбГУ](docs/Паспорт_проекта_СПбГУ_Ковалева_Алиса.md)** — структурированный паспорт проекта по установленной форме СПбГУ (проблема, научный аппарат, этапы и календарный план, смета расходов, результаты апробации).
* 📝 **[Тезисы доклада для сборника трудов СПбГУ](docs/Тезисы_доклада_СПбГУ_Ковалева_Алиса.md)** — сжатые академические тезисы (2–3 страницы) для публикации в сборнике трудов конференции.
